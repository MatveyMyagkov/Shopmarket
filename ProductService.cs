public class ProductService
{
    ...
    private static List<Product> _order = new List<Product>();

    public IReadOnlyCollection<Product> Order => _order;
    ...
    public void ShowSelected(User user)
    {
        ...
        {
            Console.WriteLine("У вас нет понравившихся товаров");
        }
        else
        {
            ...
            Console.WriteLine("2 - Добавить товар в корзину по ID");
            int options;
    ...
    {
        Console.WriteLine("Введите ID товара, который вы бы хотели удалить из понравившихся");
        int options;
        while (!int.TryParse(Console.ReadLine(), out options))
        {
            Console.WriteLine("Введите ID товара");
        ...
        if (productRemove != null)
        {
            ...
            Console.WriteLine("Товар успешно удален из избранного");
        }
        else
        {
            Console.WriteLine("Товар с указанным ID не найден в избранном");
